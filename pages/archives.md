...
.times ul li span {padding-left:7px;font-size:18px;line-height:25px;color:#555;}/*设置span标签的属性，让它来做时间显示，加一点边距，使时间显示离时间线远一点*/
...
.times ul li p {padding-left:15px;font-size:18px;line-height:25px;}/*这里利用段落标签p做文字介绍*/
</style>
